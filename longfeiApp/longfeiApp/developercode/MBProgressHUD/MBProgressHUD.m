...
- (void)setShowCloseButton:(BOOL)showCloseButton
{
    ...
    closeButton.hidden = !_showCloseButton;
}
...
- (void)setupLabels {
    ...
    [closeButton setImage:[UIImage imageNamed:@"closebox_pressed.png"] forState:UIControlStateHighlighted];
...
- (void)layoutSubviews {
    ...
    closeButton.frame = CGRectMake(CGRectGetMaxX(boxRect) - closeButton.bounds.size.width / 2 , boxRect.origin.y - closeButton.bounds.size.height / 2, closeButton.bounds.size.width, closeButton.bounds.size.height);
}
